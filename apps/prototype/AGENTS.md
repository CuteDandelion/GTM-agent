...
## Project-specific visual decision

The approved and checksum-locked source of truth is `../../docs/images/conversational-gtm-prototype.png`, with its fingerprint recorded in `../../docs/images/REFERENCE_LOCK.md`. Reproduce its app-owned content exactly across the research-progress, company-assessment, and evidence-inspection states. Do not reinterpret it as a dashboard, bento layout, alternative palette, or different component system. Any intentional visual deviation requires explicit user approval and a documented comparison.

This package is the browser-based visual-fidelity harness. The installable Expo application lives separately at `../mobile`; keep their app-owned screens visually and behaviorally aligned without modifying this package's protected device runtime.
