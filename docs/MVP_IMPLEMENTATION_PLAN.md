...
- Recording gate: satisfied for the user-approved iOS MVP demonstration by `docs/qa/native-ios/bluerose-real-provider-e2e-final-proof-2026-08-03.mp4`, backed by the passing provider-mode XCUITest and the real Bluerose/Supabase/OpenAI run history. Fixture-only visual-QA captures remain supplemental.
